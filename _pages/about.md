...
* **我们的作品**：
  * 是以刘徽撰写《九章算术注》的过程为基线、利用Unity技术开发制作一款游戏；其以寓教于乐的形式，让玩家在游玩中了解古代数学历史，见证古代数学的传承过程和辉煌过往，同时学习古代数学的实用性思想，深刻认识中国古代传统数学源于生活、注重实际应用、算理蕴含于算法的特点；数学不是一个个单调冰冷的符号，短短数笔定理的背后，是古代无数数学家上百年传承的汇集。
* **项目成果**：
